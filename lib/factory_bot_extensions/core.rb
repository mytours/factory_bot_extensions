module FactoryBot
  module Syntax
    ...
    #   
    # This syntax was derived from remi Taylor's factory_bot_extensions.
    module ObjectMethods
      ...
      # this finds the first matching factory that FactoryBot has in its registry.
      ...
      # want to find, this iterates over the given names and returns the first FactoryBot 
      # factory object that FactoryBot returns (skipping unregistered factory names).
...
# Alias FactoryBot::Syntax::ObjectMethods (which is named to be conventional with the official FactoryBot syntaxes) 
# to FactoryBotExtensions so it's easy for users to manually extend custom classes without having to remember the 
# unintuitive name of the real module.  We'll deprecate FactoryBotExtensions if we get this merged into FactoryBot.
FactoryBotExtensions = FactoryBot::Syntax::ObjectMethods

require "factory_bot_extensions/version"
